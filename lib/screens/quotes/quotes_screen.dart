      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: const TextStyle(
            ...
            fontSize: 22,
            color: Color(0xFF4A148C), // Deep lavender text
          ),
        ),
        actions: [
          Consumer<QuotesProvider>(
            builder: (_, provider, __) => IconButton(
              icon: Badge(
                ...
                child: const Icon(Icons.favorite, color: Colors.purpleAccent),
              ),
              onPressed: () {
                Navigator.push(
                  context,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: ChoiceChip(
                          ...
                          selected: isSelected,
                          selectedColor: const Color(0xFFBA68C8), // Lavender purple
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color(0xFFE6E6FA),
              Color(0xFF6A1B9A), // Deep purple-lavender
            ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFFE6E6FA), Color(0xFF6A1B9A)],
            begin: Alignment.topCenter,
            end: Alignment.bottomCenter,
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              Icon(Icons.favorite_border,
                  size: 72, color: Colors.purple.shade200),
